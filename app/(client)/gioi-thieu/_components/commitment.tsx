...
export const Commitment = () => {
	return (
		<div className="mt-10">
			...
			>
				<h1 className="px-10 font-semibold md:text-3xl text-xl drop-shadow-md text-yellow-500">
					ĐỘI NGŨ SỬA CHỮA ĐIỆN NƯỚC, CHỐNG THẤM, THÔNG NGHẸT CHUYÊN NGHIỆP VÀ
					CAO CẤP, HIỆN ĐẠI NHẤT TẠI CÁO PHÚC
				</h1>
				...
				<p className="text-sm font-light px-10 self-start mt-1">
					Mọi dịch vụ của cáo phúc đều hướng tới sự chất lượng. Từ đó nhằm mang
					lại cho bạn sự tuyệt vời để giúp bạn hưởng trọn tiện nghi trong chính
					không gian của mình.
				</p>
				<p className="text-sm font-light px-10 self-start mt-1">
